...
Myself WordPress Theme, Copyright 2019
Link: https://themepalace.com/downloads/myself
...
* TP PieBuilder
	TP PieBuilder is recommended to use for horizontal bar graph for Skills section.
